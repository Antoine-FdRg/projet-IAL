...
export class EnvService {
  ...
  static verifyQueueEnvVars = () => {
    ...
    if (!process.env.CLEANER_CONSUME_QUEUE) {
      throw new Error("Veuillez définir la variable d'environnement CLEANER_CONSUME_QUEUE");
    }
  ...
  static getConsumeQueue(): string {
    ...
    return process.env.CLEANER_CONSUME_QUEUE;
  }
